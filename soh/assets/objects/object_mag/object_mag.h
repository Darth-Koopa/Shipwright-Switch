...
// Chinese Zelda shield logo (RGBA32, 160x160) replacing the original logo in CHI mode
#define dgTitleZeldaShieldLogoCHITex "__OTR__objects/object_mag/gTitleZeldaShieldLogoCHITex"
static const ALIGN_ASSET(2) char gTitleZeldaShieldLogoCHITex[] = dgTitleZeldaShieldLogoCHITex;
...
// #region SOH [Chinese]
// Chinese title screen logo (RGBA32, 128x16) shown in CHI mode when title translation is enabled
#define dgTitleTitleCHNTex "__OTR__objects/object_mag/gTitleTitleCHNTex"
static const ALIGN_ASSET(2) char gTitleTitleCHNTex[] = dgTitleTitleCHNTex;

// iQue copyright (RGBA32, 128x32) shown in CHI mode
#define dgTitleCopyright19982003IQueTex "__OTR__objects/object_mag/gTitleCopyright19982003IQueTex"
